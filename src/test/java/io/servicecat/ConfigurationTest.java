...
public class ConfigurationTest {
    ...
    public void testGetParameterYamlDefault() throws Exception {
        ...
        String option = "file";
        String parameter = configuration.getParameter(option);
        assertThat(parameter).isEqualTo("servicecat.yaml");
    }
    ...
    public void testYamlPathSourceDir() throws Exception {
        ...
        assertThat(configuration.getYamlFilePath()).isEqualTo("/tmp/servicecat.yaml");
    }
    ...
    public void testNoFileOrSourceIYamlFileInCurrentDir() throws Exception {
        ...
        assertThat(configuration.getYamlFilePath()).isEqualTo(Paths.get("").toAbsolutePath().toString()+ "/servicecat.yaml");
    }
}